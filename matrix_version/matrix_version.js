...
window.onload = function init()
{
    ...
    modelisation_matrix_loc = gl.getUniformLocation(program, "modelisation_matrix");
...
function render()
{
    ...
    theta[0] = anglex/10.0;//replace += by = to affect the value instead of incrementing it continuously.
    theta[1] = angley/10.0;
